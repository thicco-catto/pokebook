    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <div class="d-block d-sm-block d-md-none">
                ...
                <a class="btn btn-outline-light" href="notificaciones.html?user=${user}" role="button"  style='width:100%;' data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="d-none d-sm-none d-md-block">
                <a href="Perfil.html?user=${user}&userProfile=${user}" class="nav-link active" aria-current="page" style="color: white;">Mi perfil
                    <img alt="imagen perfil" width="30" height="30" src="img/utilidades/perfil.png">
                </a>
            </div>
        </div>
    </div>
